...
while true do
	...
	elseif player.x >= 480 - player.width then player.x = 480 - player.width 
	end
	if player.y <= 0 then player.y = 0
	elseif player.y >= 272 - player.height then player.y = 272 - player.height 
	end
	--opponent Should Not go off the Window Screen
	if opponent.x <= 0 then opponent.x = 0 
	elseif opponent.x >= 480 - opponent.width then opponent.x = 480 - opponent.width 
	end
	if opponent.y <= 0 then opponent.y = 0
	elseif opponent.y >= 272 - opponent.height then opponent.y = 272 - opponent.height 
	end
	...
	-----------------------------------------------
		...
		elseif player.y >= 256 - player.height then player.y = 256 - player.height 
		end
		if opponent.y <= 115 - opponent.height then opponent.y = 115 - opponent.height
		elseif opponent.y >= 256 - opponent.height then opponent.y = 256 - opponent.height 
		end
	-------------
