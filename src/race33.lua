...
tr1 = Image.load("Sprites/Tracks/Mushroom Cup/Kalimari Desert/1.png")
tr2 = Image.load("Sprites/Tracks/Mushroom Cup/Kalimari Desert/2.png")
tr3 = Image.load("Sprites/Tracks/Mushroom Cup/Kalimari Desert/3.png")
